...
DELTA_LON = 21.0 / 3600
DELTA_LAT = 16.0 / 3600
MAP_WIDTH = int(LON_WIDTH / DELTA_LON) + 1 # 52
MAP_HEIGHT = int(LAT_WIDTH / DELTA_LAT) + 1 # 68
...
START_TIME = int(1464753600)  #  + 3600 * 5simulation start datetime (unixtime)")
...
FLAGS.use_osrm =  bool(True) # bool(True)bool(False)#   #whether to use OSRM")
