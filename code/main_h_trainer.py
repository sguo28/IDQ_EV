...
from config.setting import HEX_SHP_PATH, CS_SHP_PATH, NUM_NEAREST_CS, TRIP_FILE, TRAVEL_TIME_FILE, \
    TIMESTEP, START_OFFSET, SIM_DAYS, N_EPISODE, START_TIME, TRAINING_CYCLE, STORE_TRANSITION_CYCLE, LOW_SOC_THRESHOLD,\
    HIGH_SOC_THRESHOLD
                ...
                for day in range(SIM_DAYS):
                    ...
                    for i in range(n_steps):
                        ...
                        if len(local_state_batches) > 0:
                            action_set = dummy_get_actions(local_state_batches, num_valid_relos)
