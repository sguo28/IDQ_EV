...
class DQN_network(nn.Module):
    ...
    def __init__(self,input_dim,output_dim):
        ...
        self.hexconv_1 = hexagdly.Conv2d(in_channels=3, out_channels=16, kernel_size=5, stride=3, bias=True)
    ...
    def forward(self,local_state, global_state):
        ...
        local_fc_out = F.relu(self.local_fc(torch.cat([local_state[:,2:],one_hot_soc, one_hot_hex], dim = 1)))
